function toyShop(input) {
    ...
    const puzzeCount = Number(input[1]);
    ...
    const toyCount = puzzeCount + talkingDollCount +
      teddyBearCount + minionCount + truckCount;
    let totalCost = puzzeCount * puzzelPrice + talkingDollCount *
      talkingDollPrice + teddyBearCount * teddyBearPrice + minionCount * minionPrice 
